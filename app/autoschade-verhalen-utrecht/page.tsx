...
export const metadata: Metadata = {
  title: "Autoschade Verhalen Utrecht | Gratis Hulp bij Schade",
  description: "Autoschade in Utrecht? Wij verhalen uw schade gratis bij de tegenpartij. Snelle service in heel Utrecht en omgeving. U betaalt niets!",
  keywords: [
    "autoschade verhalen utrecht",
    "schade verhalen utrecht",
    "autoschade utrecht",
    "schade tegenpartij utrecht",
    "gratis schade verhalen utrecht"
  ],
}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-4">
              ...
              <span className="font-medium">Utrecht en omgeving</span>
            </div>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 text-center">Waarom kiezen Utrechters voor ons?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Gemiddeld binnen 6 weken uw schadevergoeding. Wij kennen de Utrechtse situatie.
                  </p>
                </CardContent>
              </Card>
              <Card>
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-lg">
            <h2 className="text-3xl font-bold mb-6">Veelvoorkomende schades in Utrecht</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-bold mb-3">Binnenstad & Centrum</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li>• Fietser/auto aanrijdingen</li>
                  <li>• Parkeerschade in oude wijken</li>
                  <li>• Schade bij laad- en losplekken</li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold mb-3">Leidsche Rijn & Vleuten</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li>• Parkeerschade nieuwbouwwijken</li>
                  <li>• Ongevallen op nieuwe wegen</li>
                  <li>• Bouwverkeer gerelateerde schade</li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold mb-3">Knooppunt Oudenrijn</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li>• Kop-staartbotsingen A2/A12</li>
                  <li>• Invoegongevallen</li>
                  <li>• File-schade</li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold mb-3">Overvecht & Zuilen</h3>
                <ul className="space-y-2 text-muted-foreground">
          ...
          {/* Werkgebied */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 text-center">Ons werkgebied rond Utrecht</h2>
            <p className="text-center text-muted-foreground mb-6">
              Wij helpen u bij schade in heel Utrecht en omgeving:
            </p>
            <div className="flex flex-wrap justify-center gap-2">
              {[
                "Utrecht Centrum", "Leidsche Rijn", "Overvecht", "Lunetten",
                "Zuilen", "Vleuten", "De Meern", "Hoograven",
                "Nieuwegein", "IJsselstein", "Zeist", "Bilthoven", "Maarssen", "Houten"
              ].map((area) => (
          ...
          <Card className="bg-gradient-to-r from-primary to-blue-700 text-white">
            <CardContent className="py-8 text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                Schade in Utrecht? Wij regelen het!
              </h2>
