        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Aangereden in Arnhem? Wij helpen u gratis uw autoschade te verhalen bij de tegenpartij. 
              Van het Centrum tot Presikhaaf, van Malburgen tot Schuytgraaf - wij staan voor u klaar.
            </p>
