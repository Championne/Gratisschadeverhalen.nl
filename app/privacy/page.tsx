...
export const metadata: Metadata = {
  title: "Privacybeleid",
  description: "Privacybeleid en AVG informatie van Gratisschadeverhalen.nl",
}
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground">
              Gratisschadeverhalen.nl respecteert de privacy van alle gebruikers van haar website en draagt er zorg voor dat de persoonlijke informatie die u ons verschaft vertrouwelijk wordt behandeld.
            </p>
          </section>
