...
const blogPosts = [
  ...
  // === NIEUWE SEO ARTIKELEN (Markdown) ===
  {
    slug: "md/artikel-185-wvw-uitgelegd-rechten-zwakke-verkeersdeelnemer",
    title: "Artikel 185 WVW Uitgelegd - Uw Rechten als Zwakke Verkeersdeelnemer",
    excerpt: "Ontdek alles over Artikel 185 WVW en uw rechten als zwakke verkeersdeelnemer bij een verkeersongeval.",
    category: "Juridisch",
    readTime: "12 min",
  ...
  {
    slug: "md/huurauto-kosten-terugkrijgen-na-ongeval",
    title: "Huurauto Kosten Terugkrijgen na Ongeval",
    excerpt: "Alles over het verhalen van huurautokosten na een verkeersongeval. Wanneer heeft u recht op vervangende vervoer?",
    category: "Financieel",
    readTime: "10 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/e-step-ongeval-wie-is-aansprakelijk",
    title: "E-Step Ongeval - Wie is Aansprakelijk?",
    excerpt: "Betrokken bij een ongeval met een e-step? Ontdek wie aansprakelijk is en hoe u uw schade kunt verhalen.",
    category: "Juridisch",
    readTime: "8 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/kettingbotsing-wie-is-aansprakelijk",
    title: "Kettingbotsing - Wie is Aansprakelijk?",
    excerpt: "Bij een kettingbotsing is de aansprakelijkheid complex. Leer wie verantwoordelijk is en hoe claims worden afgehandeld.",
    category: "Juridisch",
    readTime: "10 min",
    date: "31 januari 2026",
    featured: true,
  ...
  {
    slug: "md/dashcam-bewijs-bij-ongeval",
    title: "Dashcam als Bewijs bij Ongeval",
    excerpt: "Is dashcambeeldmateriaal bruikbaar als bewijs? Ontdek de juridische waarde en praktische tips.",
    category: "Praktisch",
    readTime: "7 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/winterbanden-verplicht-regels",
    title: "Winterbanden Verplicht? Regels in Nederland en Europa",
    excerpt: "Wanneer zijn winterbanden verplicht en wat betekent dit voor uw aansprakelijkheid bij een ongeval?",
    category: "Praktisch",
    readTime: "6 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/gladheid-aansprakelijkheid-wie-is-schuldig",
    title: "Gladheid en Aansprakelijkheid - Wie is Schuldig?",
    excerpt: "Ongeval door gladheid? Ontdek wie aansprakelijk is en hoe u uw schade kunt verhalen.",
    category: "Juridisch",
    readTime: "9 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/fileongeval-achterop-gereden-file",
    title: "Fileongeval - Achterop Gereden in File",
    excerpt: "In de file achterop gereden? Ontdek uw rechten en hoe u uw schade vergoed krijgt.",
    category: "Praktisch",
    readTime: "7 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/contra-expertise-aanvragen-wanneer-hoe",
    title: "Contra-Expertise Aanvragen - Wanneer en Hoe",
    excerpt: "Niet eens met de schatting van de verzekeraar? Leer wanneer en hoe u een contra-expertise aanvraagt.",
    category: "Financieel",
    readTime: "8 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/verzekeraar-weigert-betalen-wat-nu",
    title: "Verzekeraar Weigert te Betalen - Wat Nu?",
    excerpt: "Uw claim is afgewezen? Ontdek welke stappen u kunt ondernemen om alsnog uw geld te krijgen.",
    category: "Juridisch",
    readTime: "9 min",
    date: "31 januari 2026",
    featured: true,
  ...
  {
    slug: "md/schade-vandalisme-verhalen-mogelijkheden",
    title: "Schade Door Vandalisme Verhalen - Mogelijkheden",
    excerpt: "Auto beschadigd door vandalisme? Ontdek wanneer en hoe u schade kunt verhalen.",
    category: "Praktisch",
    readTime: "7 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/spookrijder-ongeval-schade-verhalen",
    title: "Spookrijder Ongeval - Schade Verhalen",
    excerpt: "Betrokken bij een ongeval met een spookrijder? Leer hoe u uw schade kunt claimen.",
    category: "Juridisch",
    readTime: "8 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/alcohol-aansprakelijkheid-ongeval",
    title: "Alcohol en Aansprakelijkheid bij Ongeval",
    excerpt: "Wat zijn de gevolgen van alcoholgebruik voor aansprakelijkheid en schadevergoeding?",
    category: "Juridisch",
    readTime: "9 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/auto-uitlenen-wie-aansprakelijk",
    title: "Auto Uitlenen - Wie is Aansprakelijk bij Schade?",
    excerpt: "Uw auto uitgeleend en schade ontstaan? Ontdek wie verantwoordelijk is voor de kosten.",
    category: "Juridisch",
    readTime: "7 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/directe-schadeafhandeling-dsa-wat-is-het",
    title: "Directe Schadeafhandeling (DSA) - Wat is Het?",
    excerpt: "Wat is DSA en wanneer wordt het toegepast? Alles over directe schadeafhandeling uitgelegd.",
    category: "Verzekeringen",
    readTime: "6 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/parkeergarage-schade-wie-betaalt",
    title: "Parkeergarage Schade - Wie Betaalt?",
    excerpt: "Schade opgelopen in een parkeergarage? Ontdek wie aansprakelijk is en hoe u uw schade vergoed krijgt.",
    category: "Praktisch",
    readTime: "7 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/winkelwagentje-schade-verhalen-supermarkt",
    title: "Winkelwagentje Schade - Verhalen op Supermarkt?",
    excerpt: "Auto beschadigd door een winkelwagentje? Leer wanneer u de supermarkt aansprakelijk kunt stellen.",
    category: "Praktisch",
    readTime: "6 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/buitengerechtelijke-kosten-wat-zijn-het",
    title: "Buitengerechtelijke Kosten - Wat Zijn Het?",
    excerpt: "Ontdek wat buitengerechtelijke kosten zijn en wanneer u deze kunt verhalen op de tegenpartij.",
    category: "Financieel",
    readTime: "7 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/wettelijke-rente-bij-schadeclaim",
    title: "Wettelijke Rente bij Schadeclaim",
    excerpt: "Leer hoe wettelijke rente werkt bij schadeclaims en hoeveel extra u kunt krijgen.",
    category: "Financieel",
    readTime: "6 min",
    date: "31 januari 2026",
    featured: false,
  ...
  {
    slug: "md/schade-verhalen-waarborgfonds-complete-handleiding",
    title: "Schade Verhalen via Waarborgfonds - Complete Handleiding",
    excerpt: "Dader onbekend of onverzekerd? Het Waarborgfonds kan helpen. Complete gids voor uw claim.",
    category: "Handleiding",
    readTime: "10 min",
    date: "31 januari 2026",
    featured: true,
