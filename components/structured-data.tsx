export function StructuredData() {
  ...
  const localBusinessSchema = {
    ...
    '@type': 'LocalBusiness',
    '@id': 'https://www.112autoschade.nl/#organization',
    name: '112autoschade.nl',
    alternateName: 'Autoschade Bureau',
    legalName: '112autoschade.nl',
    image: 'https://www.112autoschade.nl/og-image.jpg',
    logo: 'https://www.112autoschade.nl/logo.png',
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            availableChannel: {
              '@type': 'ServiceChannel',
              serviceUrl: 'https://www.112autoschade.nl',
            },
          },
          price: '0',
          priceCurrency: 'EUR',
  ...
  const websiteSchema = {
    ...
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: 'https://www.112autoschade.nl/search?q={search_term_string}',
      },
